 ...
 */
public abstract class SpanAbstractCalledFunction implements ICalledFunction {
    ...
    public SpanAbstractCalledFunction(long start, long end, int processId, int threadId, @Nullable ICalledFunction parent, IHostModel model) {
        if (start > end) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        SpanAbstractCalledFunction other = (SpanAbstractCalledFunction) obj;
